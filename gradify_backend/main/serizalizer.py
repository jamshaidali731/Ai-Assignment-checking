...
class ClassRoomSerializer(serializers.ModelSerializer):
    ...
    def validate_code(self, value):
        if ClassRoom.objects.filter(code=value).exists():
            raise serializers.ValidationError("This class code is already in use. Please choose a different code.")
        return value
...
class AssignmentSerializer(serializers.ModelSerializer):
    ...
    class Meta:
        ...
        fields = [
            ...
            'classroom', 'classroom_id','dead_line', 'submission_count',
        ]
...
class SubmissionSerializer(serializers.ModelSerializer):
    ...
    class Meta:
        ...
        fields = [
            ...
            'submitted_at', 'marks', 'feedback','teacher_marks','openai_score'
        ]
